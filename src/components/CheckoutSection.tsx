...
import { ArrowLeft, Package, ShieldCheck, Clock, AlertTriangle, User, MapPin, Copy, CheckCircle2, RefreshCw, Loader2, QrCode } from "lucide-react";
...
const CheckoutSection = ({ trackingCode, userName, maskedCpf, address, onBack }: CheckoutProps) => {
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="mx-auto max-w-lg px-4">
          ...
          <div className="rounded-xl overflow-hidden mb-5 bg-card" style={{ boxShadow: "0 4px 20px rgba(0,0,0,0.1)" }}>
            ...
            <div className="p-5">
              ...
              <div className="mb-4 pb-4" style={{ borderBottom: "1px solid hsl(var(--border))" }}>
                <p className="text-[10px] uppercase font-bold text-muted-foreground tracking-wider mb-2">Endereço de Entrega</p>
                <div className="flex items-start gap-2">
                  <MapPin className="h-4 w-4 shrink-0 mt-0.5" style={{ color: "hsl(207, 44%, 49%)" }} />
                  <div>
                    <p className="text-xs font-semibold text-foreground">{address.rua}, {address.numero}</p>
                    <p className="text-xs text-muted-foreground">{address.bairro}</p>
                    <p className="text-xs text-muted-foreground">{address.cidade} / {address.estado} — CEP {address.cep}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-4 pb-4" style={{ borderBottom: "1px solid hsl(var(--border))" }}>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Encomenda Internacional</p>
                  </div>
              ...
              <div className="mb-4 pb-4" style={{ borderBottom: "1px solid hsl(var(--border))" }}>
                ...
                <div className="flex items-center gap-2">
                  <div>
                    <p className="text-xs font-semibold text-foreground">Santo Andre Construtora e Incorporadora LTDA</p>
                    <p className="text-xs text-muted-foreground">CNPJ: 07.828.839/0001-61</p>
                  </div>
                </div>
              </div>
